 ...
 * @author bhk
 */
public class AddVoyageForm extends SideMenuBaseForm{

    public AddVoyageForm(Resources res) {
        super("Ajouter un voyage", BoxLayout.y());
      ...
      // addTab(swipe, res.getImage("voy.png"), spacer2, "100 Likes  ", "66 Comments", "Dogs are cute: story at 11");
       ...
       // add(new Label("Today", "TodayTitle"));*/
        ...
        FontImage arrowDown = FontImage.createMaterial(FontImage.MATERIAL_KEYBOARD_ARROW_DOWN, "Label", 3);
          ...
          TextField nome= new TextField(null, "Destination");
       // TextField activite = new TextField(null, "categorie");
         TextField effectif = new TextField(null, "Prix");
         TextField desc = new TextField(null, "Periode");
          TextField adr = new TextField(null, "Image");
          
        
 
         //TextField date = new TextField(null, "description");
        Button btn = new Button("Ajouter un voyage");
        

        btn.addActionListener((evt) -> {
            if ((nome.getText().length() == 0) || (desc.getText().length() == 0)) {
                Dialog.show("Alert", "Please fill all the fields", "OK", null);
            } else {
                try {
                    Voyage e = new Voyage(nome.getText(),Integer.parseInt(effectif.getText()),desc.getText(),adr.getText());
                    if (new ServiceVoyage().addVoyage(e)) {
                        SMS s=new SMS();
              try {
                 s.send();
                  ...
                  Dialog.show("SUCCESS", "Voyage ajouté", "OK", null);
        ...
        this.addAll(nome, effectif, desc, adr, btn);
